...
description: 查询A股、港股财务数据，包括利润表、资产负债表、现金流量表。Invoke when user asks for financial data, financial statements, profit, balance sheet, cash flow, or financial metrics. 注意：个股综合分析请使用 stock-chart-analysis skill，本skill仅用于单独查询财务报表、多股财务对比等场景。
---
